...
//	auto coin_num=m_player->getCoin();
	...
	auto labelscore=Label::createWithBMFont("fonts/bitmapFontTest2.fnt", str);
//	auto labelscore=Label::create(str,"Consolas",38);
	...
	auto labelbest=Label::createWithBMFont("fonts/bitmapFontTest2.fnt", buf);
//	auto labelbest=Label::create(buf,"Consolas",30);
	...
	labelCoin=Label::createWithBMFont("fonts/bitmapFontTest2.fnt", str_coin);
